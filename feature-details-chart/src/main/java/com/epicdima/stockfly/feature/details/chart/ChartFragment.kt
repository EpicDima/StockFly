package com.epicdima.stockfly.feature.details.chart
...
import com.epicdima.stockfly.feature.details.chart.databinding.FragmentChartBinding
...
class ChartFragment : ViewModelFragment<ChartViewModel, FragmentChartBinding>() {
            ...
            .onEach {
                binding.apply {
                    ...
                    change.setTextColor(
                        getColor(
                            when {
                                it.changeString.startsWith("+") -> com.epicdima.stockfly.core.ui.R.color.green
                                it.changeString.startsWith("-") -> com.epicdima.stockfly.core.ui.R.color.red
    ...
    private fun unselectButton(button: TextView) {
        button.apply {
            setTextColor(context.color(com.epicdima.stockfly.core.ui.R.color.black))
    ...
    private fun selectButton(button: TextView) {
        button.apply {
            setTextColor(context.color(com.epicdima.stockfly.core.ui.R.color.white))
