...
class ChartView @JvmOverloads constructor(
    ...
    private val lineColor = context.color(com.epicdima.stockfly.core.ui.R.color.black)
    private val startGradientColor = context.color(com.epicdima.stockfly.core.ui.R.color.grey)
